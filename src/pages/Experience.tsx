...
import onsiteBarberImg from "@/assets/onsite-barber.jpg";
...
const lockerRoomImg = "https://xhqqxukgsaxabyvbfinn.supabase.co/storage/v1/object/public/video/progradelockerom";
...
const lifestylePerks = [
  ...
  { icon: Scissors, title: "On-Site Barber", description: "Look good, play good. Our on-site barber keeps athletes sharp and camera-ready for game day and showcases.", image: onsiteBarberImg },
              ...
              <SectionReveal key={index} delay={index * 100}>
                <div className="group relative bg-background/60 border border-border/20 overflow-hidden hover:border-primary/40 transition-all duration-300 h-full">
                  <div className="relative h-40 md:h-48 overflow-hidden">
                    <img src={perk.image} alt={perk.title} className={`w-full h-full object-cover group-hover:scale-105 transition-transform duration-500`} style={perk.title === 'Recovery & Arm Care' ? { objectPosition: 'center 30%' } : undefined} loading="lazy" />
