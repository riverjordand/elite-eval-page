...
const SectionHeading = ({ children }: { children: React.ReactNode }) => (
  <h3 className="font-bebas text-fluid-2xl uppercase tracking-wide text-primary border-b border-primary/20 pb-2 mb-6">
    {children}
  </h3>
);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 sm:pt-32 pb-fluid-lg px-fluid-container-px">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-oswald text-center text-muted-foreground text-fluid-base mb-fluid-md max-w-xl mx-auto">
