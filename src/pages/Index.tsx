  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LandingHero
        ...
        subHeadline="Start with a Free College-Ready Player Evaluation — Get a complete breakdown of where your athlete stands and what it takes to play at the next level"
