      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card border-2 border-border rounded-xl p-8 md:p-12 mb-8">
            <h3 className="text-2xl font-bebas font-bold uppercase mb-8 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              {evaluationPoints.map((point, index) => (
                <div key={index} className="flex items-start gap-4">
                  ...
                  <p className="text-foreground leading-relaxed font-oswald">{point}</p>
                </div>
              ))}
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-6 font-oswald">
          ...
          <div className="text-center">
            <p className="text-muted-foreground italic font-oswald">
