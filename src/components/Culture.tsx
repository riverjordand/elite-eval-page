        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
          <div className="space-y-6">
            <div className="bg-card border border-border p-6 rounded-lg">
              <h3 className="text-2xl font-bold uppercase mb-3 text-primary">Immersive Training</h3>
            ...
            <div className="bg-card border border-border p-6 rounded-lg">
              <h3 className="text-2xl font-bold uppercase mb-3 text-primary">Academic Excellence</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border border-border p-6 rounded-lg">
              <h3 className="text-2xl font-bold uppercase mb-3 text-primary">Professional Exposure</h3>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="relative h-[600px] rounded-xl overflow-hidden">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <h3 className="text-3xl font-bold uppercase text-foreground mb-2">
