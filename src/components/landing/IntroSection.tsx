...
const IntroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-28 xl:py-32 overflow-hidden">
      ...
      <div className="container relative z-20 mx-auto px-6 lg:px-12">
        <div className="max-w-2xl">
          ...
          <h2 className="font-bebas uppercase leading-[0.95] tracking-tight mb-6 lg:mb-8">
            <span 
              className={`block text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-foreground drop-shadow-[0_4px_20px_rgba(0,0,0,0.5)] transition-all duration-700 ease-out ${
            ...
            <span 
              className={`block text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-primary glow-primary-intense transition-all duration-700 ease-out ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
          ...
          <div className="space-y-4 lg:space-y-5 mb-6 lg:mb-8">
            <p 
              className={`font-oswald text-base md:text-lg lg:text-xl text-foreground/85 leading-relaxed transition-all duration-700 ease-out ${
          ...
          {/* Highlight Box */}
          <div 
            className={`relative border-l-4 border-primary pl-5 lg:pl-6 py-4 lg:py-5 bg-gradient-to-r from-primary/15 via-primary/5 to-transparent rounded-r-lg transition-all duration-700 ease-out ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
            }`}
            style={{ 
