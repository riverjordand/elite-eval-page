...
const LandingStatsBar = () => {
  return (
    <section className="relative bg-primary py-4 md:py-6 lg:py-8 overflow-hidden">
      {/* Dynamic background */}
      ...
      <div className="container relative mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 lg:gap-16 max-w-5xl mx-auto">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="font-bebas text-2xl md:text-4xl lg:text-5xl xl:text-6xl text-primary-foreground font-black leading-none">
                {stat.value}
              </div>
              <div className="font-oswald text-[10px] md:text-sm lg:text-base text-primary-foreground/80 uppercase tracking-wider mt-1">
                {stat.label}
              </div>
            </div>
          ))}
