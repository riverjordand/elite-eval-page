      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bebas font-black uppercase px-4 leading-tight">
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 md:space-y-8 text-center md:text-left">
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground font-oswald leading-relaxed">
              ...
              <div className="space-y-3 md:space-y-4 pt-6">
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-oswald font-semibold text-foreground">
                  LPA is not a casual training facility.
                </p>
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-oswald font-semibold text-foreground italic">
