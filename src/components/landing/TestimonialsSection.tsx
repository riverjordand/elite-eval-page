...
const testimonials = [
  ...
  { video: "/testimonials/parent-testimonial-2.mp4", thumb: "/testimonials/parent-testimonial-2-thumb.jpg", quote: "LPA gave my daughter clarity on exactly what to work on. Now she has 3 college offers.", name: "Sarah T.", role: "Mother of HS Junior", highlight: "3 Offers" },
  { video: "/testimonials/parent-testimonial-3.mp4", thumb: "/testimonials/parent-testimonial-3-thumb.jpg", quote: "Worth every penny. The technology and coaching are on another level.", name: "James R.", role: "Father of Travel Ball Player", highlight: "Pro-Level" },
