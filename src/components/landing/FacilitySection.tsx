...
const facilities = [
  ...
  { title: "Classroom", subtitle: "Flexible Schooling", tagline: "Education built for athletes", description: "Dedicated classroom space where middle and high school student-athletes spend 2 hours per day ensuring grades are met with an advisor.", image: `${STORAGE_BASE}/Classroom`, features: ["NCAA-approved standards", "Fully accredited by Cognia", "Weekly grade checks", "College prep focused", "Flexible scheduling"], stat: "Academics" },
