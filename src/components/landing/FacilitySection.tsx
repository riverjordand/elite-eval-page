...
const facilities = [
  { title: "Baseball Training", subtitle: "Game Speed", tagline: "Every rep simulates game conditions", description: "Indoor turf, retractable hitting tunnels, real-time data feedback from elite-level equipment.", image: facilityTraining, features: ["Trackman", "HitTrax", "Rapsodo", "2K sq ft game simulation"], stat: "24K sq ft" },
