...
{ to: "https://parenthub.legendaryprepacademy.com/home", label: "Parent Hub", external: true },
...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[70] bg-background/80 backdrop-blur-md border-b border-border/30">
